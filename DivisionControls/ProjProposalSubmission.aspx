                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="status-field">
                                <asp:ListItem Text="Forward" Value="Approved"></asp:ListItem>
                                <asp:ListItem Text="Reject" Value="Rejected"></asp:ListItem>
                            </asp:DropDownList>
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="update-button" CommandName="UpdateSubmission" CommandArgument='<%# Eval("ProposalID") + "," + Eval("ScientID") + "," + Eval("[SupervisoerID]")+","+Eval("PropSubDate", "{0:dd/MM/yyyy}")  %>' target="_blank" />
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
